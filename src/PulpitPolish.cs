    ...
    internal static class PulpitPolish
    {
        ...
        private static IEnumerator SettlePrayerButtonLayout(int generation)
        {
            ...
            for (int pass = 0; pass < 3; pass++)
            {
                ...
                // A second settled frame verifies any button move or root-window
                // growth. Usually this exits on pass 1; the third pass is only a
                // bounded rounding/anchor safety net, never permanent polling.
